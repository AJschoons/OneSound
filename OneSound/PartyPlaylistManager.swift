...
class PartyPlaylistManager
{
        ...
        if !updating
        {
            ...
            OSAPI.sharedClient.GETPartyPlaylist(LocalParty.sharedParty.partyID, page: currentPage, pageSize: pageSize,
                success: { data, responseObject in
                    ...
                    self.updateSongsFromJSON(responseJSON, completion: completion)
                },
    ...
    private func updateSongsFromJSON(json: JSONValue, completion: completionClosure? = nil)
    {
